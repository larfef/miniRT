...
UTILS			=	init_struct progress_bar
RENDERING		=	check_light_coordinates cylinder_intersection get_nearest_intersection init_fct_ptr_normal iterate_through_shapes_list iterate_through_viewport jittered_grid plane_intersection \
